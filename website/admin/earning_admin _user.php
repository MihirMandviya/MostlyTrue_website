...
<head>
    ...
    <title>Earning | Mostly True</title>    
    <link href="css/earning_admin.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
            ...
            <div class="details">
                ...
                <div class="recentOrders">
                    ...
                    <thead>
                        ...
                        <?php
                        include('dbcon.php');
                        $query=mysqli_query($conn,"SELECT payment.payment_id,payment.amount, payment.date, registered_user.Name FROM payment,registered_user,payuser_join WHERE payment.payment_id=payuser_join.payment_id AND payuser_join.RUserID=registered_user.RUserID ORDER BY `date` DESC")or die(mysqli_error($conn));
