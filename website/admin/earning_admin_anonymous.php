            ...
            <div class="details">
                ...
                <div class="recentOrders">
                    ...
                    <thead>
                        ...
                        $aquery=mysqli_query($conn,"SELECT payment_id, amount, date FROM payment WHERE payment_id NOT IN (SELECT payment.payment_id FROM payment,payuser_join WHERE payment.payment_id=payuser_join.payment_id) ORDER BY `date` DESC")or die(mysqli_error($conn));
                        $srno=1;
