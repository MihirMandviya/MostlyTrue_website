            ...
            <div class="details">
                ...
                <div class="recentOrders">
                    ...
                    <table>
                        ...
                        <?php
                        include('dbcon.php');
                        $query=mysqli_query($conn,"SELECT search_result.Headline,search_result.Result,search_result.Date, registered_user.Name FROM search_result,registered_user,ruser_join WHERE search_result.SearchID=ruser_join.SearchID AND ruser_join.RUserID=registered_user.RUserID ORDER BY `date` DESC")or die(mysqli_error($conn));
                        $srno=1;
