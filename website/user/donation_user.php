...
<head>
    ...
    <title>Donation | Mostly True</title>
    <!--<link rel="stylesheet" href="css/searchhistory_user.css">-->
    <link href="css/donation_user.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
            ...
            <div class="details">
                ...
                <div class="recentOrders">
                    ...
                    <?php
                         include('dbcon.php');
                         $id=$_SESSION["id"];
                         $query=mysqli_query($conn,"SELECT payment.payment_id, payment.amount, payment.date FROM payment, payuser_join WHERE payuser_join.payment_id=payment.payment_id  AND payuser_join.RUserID=$id ORDER BY payment.date DESC");
                         $srno=1;
